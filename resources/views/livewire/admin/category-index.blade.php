<div class="py-6 sm:py-10 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center gap-3 mb-6 sm:mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold">Categorias do blog</h2>
                <p class="text-sm text-zinc-500 dark:text-zinc-400">Crie, edite e organize categorias.</p>
            </div>
        </div>
        ...
        <form wire:submit="save" class="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 sm:p-5 mb-6 space-y-4">
            <h3 class="text-sm font-semibold">{{ $editingId ? 'Editar categoria' : 'Nova categoria' }}</h3>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label class="block text-xs font-medium text-zinc-500 dark:text-zinc-400 mb-1">Nome</label>
            ...
            <div>
                <label class="block text-xs font-medium text-zinc-500 dark:text-zinc-400 mb-1">Descrição</label>
            ...
            @forelse ($categories as $category)
                <div class="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 flex items-center justify-between gap-3">
                    <div class="min-w-0">
                        ...
                        @endif
                        <p class="text-xs text-zinc-400 dark:text-zinc-500 mt-1">{{ $category->posts_count }} post(s)</p>
                    </div>
